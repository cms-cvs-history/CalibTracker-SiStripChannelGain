...
TString tickmarks(char * tick_timing_file="/castor/cern.ch/cms/testbeam/tkmtcc/P5_data/TBmonitor/TBMonitor0020303_000.root"){ //  tick_timing_file: timing file
  // style
...
/*
  ...
  TFile fgaincalib("files/apvgain_histograms.root");
...
//          cout<<"dedx="<<local_charge_over_path<<" tickheight="<<local_tickheight<<" dedx/tickheight="<<dedx_over_tickheight<<endl;
          ...
          MuonChargeVsTickHeight->Fill(local_charge_over_path,local_tickheight);
        }
      }
    }
  }
